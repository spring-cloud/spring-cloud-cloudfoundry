...
public class VcapServiceCredentialsEnvironmentPostProcessorTests {
	...
	public void addTokenUri() {
		TestPropertyValues.of( "vcap.services.sso.credentials.accessTokenUri:https://example.com").applyTo(this.environment);
		this.listener.postProcessEnvironment(this.environment, new SpringApplication());
	...
	public void addTokenUriAuthDomain() {
		TestPropertyValues.of("vcap.services.sso.credentials.auth-domain:https://example.com").applyTo(this.environment);
		this.listener.postProcessEnvironment(this.environment, new SpringApplication());
	...
	public void addUserInfoUri() {
		TestPropertyValues.of( "vcap.services.sso.credentials.userInfoUri:https://example.com").applyTo(this.environment);
		this.listener.postProcessEnvironment(this.environment, new SpringApplication());
		assertEquals("https://example.com", this.environment
	...
	public void addServiceId() {
		TestPropertyValues.of("vcap.services.my.credentials.accessTokenUri:https://example.com",
	...
	public void addJwtKeyUri() {
		TestPropertyValues.of("vcap.services.sso.credentials.keyUri:https://example.com").applyTo(this.environment);
		this.listener.postProcessEnvironment(this.environment, new SpringApplication());
		assertEquals("https://example.com", this.environment
